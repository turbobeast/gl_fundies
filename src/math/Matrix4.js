...
export default class Matrix4 {
  ...
  transpose () {
    ...
    let A12 = this.elements[1]
    let A13 = this.elements[2]
    let A14 = this.elements[3]
    let A21 = this.elements[4]
    let A22 = this.elements[5]
    let A23 = this.elements[6]
    let A24 = this.elements[7]
    let A31 = this.elements[8]
    let A32 = this.elements[9]
    let A33 = this.elements[10]
    let A34 = this.elements[11]
    let A41 = this.elements[12]
    let A42 = this.elements[13]
    let A43 = this.elements[14]
    let A44 = this.elements[15]
  ...
  multiply (matb) {
    ...
    let B11 = matb.elements[0]; let B12 = matb.elements[1]; let B13 = matb.elements[2]; let B14 = matb.elements[3]
    let B21 = matb.elements[4]; let B22 = matb.elements[5]; let B23 = matb.elements[6]; let B24 = matb.elements[7]
    let B31 = matb.elements[8]; let B32 = matb.elements[9]; let B33 = matb.elements[10]; let B34 = matb.elements[11]
    let B41 = matb.elements[12]; let B42 = matb.elements[13]; let B43 = matb.elements[14]; let B44 = matb.elements[15]
  ...
  createZRotMatrixFromDegrees (degrees) {
    let rads = GLUtils.toRadians(degrees)
